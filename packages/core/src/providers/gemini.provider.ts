...
export class GeminiProvider implements AIProvider {
  ...
  public async generateListing(
    ...
    if (input.language && input.language !== 'auto' && input.language !== 'en') {
      textPromptParts.push(`Target Output Language: ${input.language.toUpperCase()}`);
    } else {
      textPromptParts.push('Target Output Language: ENGLISH (All fields must be in clear, professional English)');
    }
